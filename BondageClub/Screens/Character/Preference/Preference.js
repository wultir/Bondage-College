...
function PreferenceInit(C) {
	...
	if (typeof C.ChatSettings.WhisperedEmotes !== "boolean") C.ChatSettings.WhisperedEmotes = false;
...
function PreferenceSubscreenChatRun() {
	...
	DrawCheckbox(1200, 732, 64, 64, TextGet("WhisperedEmotes"), Player.ChatSettings.WhisperedEmotes);
	MainCanvas.textAlign = "center";
...
function PreferenceSubscreenChatClick() {
	...
	if (MouseXIn(1200, 64)) {
		...
		if (MouseYIn(732, 64)) Player.ChatSettings.WhisperedEmotes = !Player.ChatSettings.WhisperedEmotes;
	}
